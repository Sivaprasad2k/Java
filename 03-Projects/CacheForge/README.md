...
> **Educational Milestone**: Built strictly from first principles using Core Java & Advanced Java without external frameworks (No Spring, Spring Boot, Redis, Hibernate, or third-party libraries).
...
| :--- | :--- |
| **Object-Oriented Design** | Encapsulated domain objects (`CacheEntry`, `CacheConfig`, `CacheResult`, `CacheStatistics`) prioritizing composition over inheritance. |
...
## 4. Supported Interactive CLI Commands
...
CACHEFORGE> SET session:99 AUTH_TOKEN 60
OK (TTL: 60s)
...
CACHEFORGE> TTL session:99
(integer) 58

CACHEFORGE> EXPIRE user:101 120
(integer) 1

CACHEFORGE> STATS
CacheStatistics[Hits: 1, Misses: 0, Puts: 2, Removals: 0, Evictions: 0, Expirations: 0, Hit Ratio: 100.00%]

CACHEFORGE> ANALYTICS
--- Cache Telemetry Analytics ---
Top 3 Keys       : [user:101, session:99]
Average TTL      : 58.00 seconds
Total Read Ops   : 1
Namespaces       : 
  * [session]: [session:99]
  * [user]: [user:101]
...
* **Single-Threaded Throughput**: ~450,000 ops/sec (Average Latency: ~2.2 µs/op)
* **Multi-Threaded Throughput (10 Threads)**: ~300,000 ops/sec (0 Race Condition Errors)
